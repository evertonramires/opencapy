...
- When a to-do is really a multi-step project, break it into 3 to 6 small subtasks with add_subtasks so its progress bar and Gantt view work; if the breakdown isn't obvious, ask one short question first
